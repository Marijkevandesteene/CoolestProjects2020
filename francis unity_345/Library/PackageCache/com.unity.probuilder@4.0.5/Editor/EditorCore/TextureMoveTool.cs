    ...
    class TextureMoveTool : TextureTool
    {
        ...
        protected override void DoTool(Vector3 handlePosition, Quaternion handleRotation)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    m_Position.x = UnityEngine.ProBuilder.Snapping.SnapValue(m_Position.x, relativeSnapX);
                    m_Position.y = UnityEngine.ProBuilder.Snapping.SnapValue(m_Position.y, relativeSnapY);
                }
                else if (progridsSnapEnabled)
                {
                    m_Position.x = UnityEngine.ProBuilder.Snapping.SnapValue(m_Position.x, progridsSnapValue);
                    m_Position.y = UnityEngine.ProBuilder.Snapping.SnapValue(m_Position.y, progridsSnapValue);
                }
